...
export const ui = {
  en: {
    ...
    legalReview: "Publication-review placeholder. This page must be completed and legally reviewed before launch.",
    submit: "Send inquiry",
  ...
  de: {
    ...
    legalReview: "Platzhalter für die Veröffentlichungsprüfung. Diese Seite muss vor dem Launch rechtlich geprüft und vervollständigt werden.",
  ...
  da: {
    ...
    downloadPdf: "Download PDF",
    downloadDocx: "Download DOCX",
    legalReview: "Publikations-review-pladsholder. Siden skal færdiggøres og juridisk gennemgås før lancering.",
